// src/contracts/templates/aposentadoria.js
// Migrado de: APOSENTADORIA.pdf (enviado por Felipe em 01/09/2026).
// Texto jurídico reproduzido literalmente — inclusive pequenas inconsistências de
// acentuação do original ("previa", "ate", "duvidas") NÃO foram corrigidas, por pedido
...
export function buildContratoAposentadoria(client) {
    ...
    return `
        ...
        <p><strong>Cláusula Primeira</strong>: O presente contrato tem como objeto a Prestação de Serviços de Assessoria Jurídica ao Contratante, no <strong>REQUERIMENTO APOSENTADORIA.</strong></p>
        ...
        <p style="text-align:center">Rio de Janeiro, ____/____/____.</p>
