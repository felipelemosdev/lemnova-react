// src/contracts/templates/auxilioAcidente.js
// Migrado de: auxilio_acidente.pdf (enviado por Felipe em 01/09/2026).
// Texto jurídico reproduzido literalmente. Note que na Cláusula Quinta o original pula
// direto da alínea "a" pra "c" (não existe alínea "b") — mantido exatamente assim, sem
// "corrigir" a numeração, por pedido explícito de fidelidade total ao PDF.
...
export function buildContratoAuxilioAcidente(client) {
    ...
    return `
        <p>Por este instrumento particular, o Sr(a). ${f.nome}, brasileiro (a), ${f.nacionalidade}, ${f.estadoCivil}, Portador da Cédula de Identidade nº. ${f.rg}, inscrito no CPF sob o nº. ${f.cpf}, residente e domiciliado ${f.endereco}.</p>
        ...
        <p><strong>Cláusula Primeira</strong>: O presente contrato tem como objeto a Prestação de Serviços de Assessoria Jurídica ao Contratante, no <strong>REQUERIMENTO DE AUXILIO-ACIDENTE</strong>, em sede administrativo e/ou judicial, até o trâmite final do processo.</p>
        ...
        <p>a) No importe de 5 salários benefícios e 30% (trinta por cento) sobre o proveito econômico do processo a titulo de atrasados sendo concedido em administrativamente e/ou RPV- Precatório, em se tratando de beneficio de auxilio doença concedido em prazo indeterminado.<br>
        c) Em sendo concedido em esfera judicial os honorários serão no importe de 6 salários benefícios e 30% (trinta por cento) sobre o proveito econômico do processo a titulo de atrasados sendo concedido em administrativamente e/ou RPV- Precatório.<br>
        ...
        <p><strong>Cláusula Sétima</strong>: Às custas e demais despesas judiciais ou extrajudiciais correrão por conta exclusiva do Contratante, que será a única responsável pelas consequências do não pagamento das mesmas nas épocas oportunas;</p>
        ...
        c) em razão da Contratante deixar de realizar algum pagamento devido aos Contratados por prazo superior a 30 (trinta) dias, sem qualquer comunicação.<br>
        ...
        <p><strong>Cláusula Décima Oitava:</strong> Fica acertado entre as partes que as informações prestadas entre as mesmas serão consideradas confidenciais e deverão ser mantidas em absoluto sigilo por ambas. Sobretudo no que tange aos trabalhos técnicos-jurídicos desenvolvidos pelos Contratados a Contratante deverá reservar sigilo perante terceiros, inclusive do teor do presente contrato. A obrigação de confidencialidade disposta nesta cláusula, perdurará mesmo após o término, rescisão ou extinção do presente contrato;</p>
        ...
        <p>Cláusula Vigésima Terceira: Estipulam o Foro da comarca de Duque de Caxias/RJ, para dirimir litígios decorrentes do presente contrato. E, por estarem assim contratados assinam o presente contrato em duas vias de igual teor.</p>

        <p style="text-align:center">Duque de Caxias, _____ de _______________________ de _________.</p>
