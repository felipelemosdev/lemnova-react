// src/contracts/templates/loasDeficiente.js
// Migrado de: Loas_deficiente.pdf (enviado por Felipe em 01/09/2026).

import { clientFields } from "../../shared.js";

export function buildContratoLoasDeficiente(client) {
    ...
    return `
        ...
        <p style="text-align:center">Rio de Janeiro, ____/______/____.</p>
